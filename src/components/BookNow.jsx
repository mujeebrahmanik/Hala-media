...
const BookNow = () => {
  ...
  return (
    <div className="relative flex flex-col mt-20 border-b border-neutral-900 rounded-lg py-10 px-5 justify-center items-center" id='contact'>
  ...
  <div className="text-center relative z-10 w-full max-w-6xl">
    <h2 className="text-3xl sm:text-4xl lg:text-5xl mt-8 lg:mt-8 tracking-wide font-medium text-white">
      Get in Touch
    </h2>

    <div className="grid grid-cols-1 lg:grid-cols-2 mt-10 lg:mt-15 gap-8 lg:gap-6">
