            ...
            <div className="container px-4 mx-auto relative text-sm">
                <div className="flex justify-between items-center">
                    ...
                    <ul className='hidden lg:flex ml-14 space-x-12'>
                        <li><Link to='home' smooth={true} duration={500} className='cursor-pointer hover:font-bold hover:text-[#791BBA]'>Home</Link></li>
                        <li><Link to='services' smooth={true} duration={500} className='cursor-pointer hover:font-bold hover:text-[#791BBA]'>Services</Link></li>
                        <li><Link to='testimonials' smooth={true} duration={500} className='cursor-pointer hover:font-bold hover:text-[#791BBA]'>Testmonials</Link></li>
                    </ul>
                ...
                {drawerOpen &&
                    <div className="fixed right-0 z-20 bg-neutral-900 w-full p-12 flex flex-col justify-center items-center lg:hidden gap-3">
                        ...
                        <div className="flex justify-center items-center">
                            <Link  to='contact' smooth={true} duration={500} className='bg-gradient-to-r from-[#791BBA] to-blue-500 py-2 px-3 rounded-md cursor-pointer'>Contact</Link>
                        </div>
                    </div>
                }
            </div>
